...
public abstract class FirebaseRecyclerAdapter<ViewHolder extends RecyclerView.ViewHolder, T>
    ...
    /**
     * Returns the service_card in the specified position
     *
     * @param position Position of the service_card in the adapter
     * @return the service_card
     */
    ...
    /**
     * Returns the position of the service_card in the adapter
     *
    ...
    /**
     * Check if the searched service_card is in the adapter
     *
     * @param item Item to be searched
     * @return true if the service_card is in the adapter, false otherwise
     */
    ...
    /**
     * Called after an service_card has been added to the adapter
     *
     * @param item     Added service_card
     * @param key      Key of the added service_card
     * @param position Position of the added service_card in the adapter
     */
    protected abstract void itemAdded(T item, String key, int position);

    /**
     * Called after an service_card changed
     *
     * @param oldItem  Old version of the changed service_card
     * @param newItem  Current version of the changed service_card
     * @param key      Key of the changed service_card
     * @param position Position of the changed service_card in the adapter
     */
    protected abstract void itemChanged(T oldItem, T newItem, String key, int position);

    /**
     * Called after an service_card has been removed from the adapter
     *
     * @param item     Removed service_card
     * @param key      Key of the removed service_card
     * @param position Position of the removed service_card in the adapter
     */
    protected abstract void itemRemoved(T item, String key, int position);

    /**
     * Called after an service_card changed position
     *
     * @param item        Moved service_card
     * @param key         Key of the moved service_card
     * @param oldPosition Old position of the changed service_card in the adapter
     * @param newPosition New position of the changed service_card in the adapter
     */
